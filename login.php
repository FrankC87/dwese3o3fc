    ...
    <main class="container">
        <div class="row" id="cuerpo">
            ...
            <div class="row">
                ...
                if (empty($result) || !password_verify($password,$result['pass'])) {
                    ?>
                    <h4>Usuario o contraseña incorrectos, intentelo de nuevo</h4>
            </div>
            <div class="row">
                    ...
                    <div class="row">                  
                    <button class="btn btn-success" onclick="location.href = 'details.php'">Continuar</button>
                    <?php
                }
                ?>
